...
// Node Main Function
{
ros::init(argc, argv, "fla_topic_publisher_node");	// Initializes Node Name
ros::NodeHandle nh;		
...
ros::Publisher fla_topic_publisher =
nh.advertise<fla_sumup_pkg::MsgTutorial>("ros_tutorial_msg", 100);
// Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
ros::Rate loop_rate(10);
fla_sumup_pkg::MsgTutorial msg; 	
...
fla_topic_publisher.publish(msg);		 // Publishes 'msg' message
