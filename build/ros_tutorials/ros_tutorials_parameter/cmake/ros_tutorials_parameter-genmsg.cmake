...
get_filename_component(_filename "/home/awais/catkin_ws/src/ros_tutorials/ros_tutorials_parameter/srv/SrvTutorial.srv" NAME_WE)
add_custom_target(_ros_tutorials_parameter_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tutorials_parameter" "/home/awais/catkin_ws/src/ros_tutorials/ros_tutorials_parameter/srv/SrvTutorial.srv" ""
)
...
_generate_srv_cpp(ros_tutorials_parameter
  "/home/awais/catkin_ws/src/ros_tutorials/ros_tutorials_parameter/srv/SrvTutorial.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_parameter)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_parameter\")")
  # install generated code
  install(
