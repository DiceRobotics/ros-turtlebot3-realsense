...
"""autogenerated by genpy from moving_object_msgs/SocialObject.msg. Do not edit."""
import sys
...
class SocialObject(genpy.Message):
  _md5sum = "aa604aba50f59d0fd547bd74d7c34114"
  _type = "moving_object_msgs/SocialObject"
...
float64 z
"""
  __slots__ = ['id','name','position','velocity','reliability','tagnames','tags']
  _slot_types = ['int32','string','geometry_msgs/Point','geometry_msgs/Point','float64','string[]','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,name,position,velocity,reliability,tagnames,tags
    ...
    """
    if args or kwds:
      super(SocialObject, self).__init__(*args, **kwds)
