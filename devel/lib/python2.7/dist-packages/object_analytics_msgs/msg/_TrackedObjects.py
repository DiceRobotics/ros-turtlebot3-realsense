...
"""autogenerated by genpy from object_analytics_msgs/TrackedObjects.msg. Do not edit."""
import sys
...
class TrackedObjects(genpy.Message):
  _md5sum = "36a3a0ceb337855e0d695e5cebe8d607"
  _type = "object_analytics_msgs/TrackedObjects"
...
"""
  ...
  _slot_types = ['std_msgs/Header','object_analytics_msgs/TrackedObject[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackedObjects, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_analytics_msgs.msg.TrackedObject()
        start = end
        end += 4
