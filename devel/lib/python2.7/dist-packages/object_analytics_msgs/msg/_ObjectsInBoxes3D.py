...
"""autogenerated by genpy from object_analytics_msgs/ObjectsInBoxes3D.msg. Do not edit."""
import sys
...
import object_analytics_msgs.msg
import std_msgs.msg

class ObjectsInBoxes3D(genpy.Message):
  _md5sum = "9c0963ec04b8a73778b7dfa2abfbc0cf"
  _type = "object_analytics_msgs/ObjectsInBoxes3D"
...
float32 y
float32 z"""
  __slots__ = ['header','objects_in_boxes']
  _slot_types = ['std_msgs/Header','object_analytics_msgs/ObjectInBox3D[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectsInBoxes3D, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.objects_in_boxes is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.objects_in_boxes)
      buff.write(_struct_I.pack(length))
      for val1 in self.objects_in_boxes:
        _v1 = val1.roi
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = object_analytics_msgs.msg.ObjectInBox3D()
        _v4 = val1.roi
        _x = _v4
        start = end
        end += 17
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3f().unpack(str[start:end])
        self.objects_in_boxes.append(val1)
      return self
