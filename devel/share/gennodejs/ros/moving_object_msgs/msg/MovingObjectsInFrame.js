...
class MovingObjectsInFrame {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MovingObjectsInFrame(null);
  ...
  static datatype() {
    ...
    return 'moving_object_msgs/MovingObjectsInFrame';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7c03861f72f429096f474b692be42623';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovingObjectsInFrame(null);
...
module.exports = MovingObjectsInFrame;
