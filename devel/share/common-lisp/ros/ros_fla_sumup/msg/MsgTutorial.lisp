...
(cl:in-package ros_fla_sumup-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MsgTutorial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgTutorial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_fla_sumup-msg:<MsgTutorial> is deprecated: use ros_fla_sumup-msg:MsgTutorial instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <MsgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_fla_sumup-msg:stamp-val is deprecated.  Use ros_fla_sumup-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_fla_sumup-msg:data-val is deprecated.  Use ros_fla_sumup-msg:data instead.")
  (data m))
